...
Covers:
- Loader utilities
- GET /api/v1/library/accessories (flat list + grouped categories)
- GET /api/v1/library/accessories/{id}
- POST /api/v1/compute/lossbreakdown — flat mode (backward-compat)
- POST /api/v1/compute/lossbreakdown — segmented mode with D-W geometry
...
# ---------------------------------------------------------------------------
# GET /api/v1/library/accessories — flat list
# ---------------------------------------------------------------------------


def test_get_library_accessories_status():
    resp = client.get("/api/v1/library/accessories")
...
# ---------------------------------------------------------------------------
# GET /api/v1/library/accessories — grouped categories field
# ---------------------------------------------------------------------------
...
def test_get_accessory_by_id_endpoint():
    resp = client.get("/api/v1/library/accessories/cv_swing")
    assert resp.status_code == 200
    data = resp.json()
...
def test_get_accessory_by_id_endpoint_not_found():
    resp = client.get("/api/v1/library/accessories/nonexistent_id_xyz")
    assert resp.status_code == 404
    assert "not found" in resp.json()["detail"].lower()


def test_get_accessory_mag_meter():
    resp = client.get("/api/v1/library/accessories/mag_meter")
    assert resp.status_code == 200
    data = resp.json()
...
# ---------------------------------------------------------------------------
# POST /api/v1/compute/lossbreakdown — flat mode (backward-compatible)
# ---------------------------------------------------------------------------
...
def test_lossbreakdown_status():
    resp = client.post("/api/v1/compute/lossbreakdown", json=BASIC_REQUEST)
    assert resp.status_code == 200
...
def test_lossbreakdown_k_override():
    ...
    resp = client.post("/api/v1/compute/lossbreakdown", json=req)
    data = resp.json()
...
def test_lossbreakdown_suction_flat_items_use_D_mm_not_default():
    ...
    resp_400 = client.post("/api/v1/compute/lossbreakdown", json=req_with_D)
    resp_200 = client.post("/api/v1/compute/lossbreakdown", json=req_default_D)
...
def test_lossbreakdown_item_segment_echoed():
    ...
    item = client.post("/api/v1/compute/lossbreakdown", json=req).json()["items"][0]
...
# ---------------------------------------------------------------------------
# POST /api/v1/compute/lossbreakdown — SEGMENTED MODE with pipe geometry (D-W)
# ---------------------------------------------------------------------------
...
def test_segmented_mode_status():
    resp = client.post("/api/v1/compute/lossbreakdown", json=SEGMENTED_REQUEST)
    assert resp.status_code == 200
