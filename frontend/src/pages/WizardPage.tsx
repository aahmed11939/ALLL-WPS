...
const STEPS: StepDef[] = [
  ...
  { label: "Pump Selection",      shortLabel: "Pump Type", badge: "Type" },
  { label: "Discharge Pipeline",  shortLabel: "Discharge", badge: "Pipe" },
  { label: "Pump Curves",         shortLabel: "Curves",    badge: "H-Q" },
  { label: "Hydraulic Results",   shortLabel: "Hydraulics",badge: "TDH" },
  { label: "Water Hammer",        shortLabel: "WH",        badge: "Surge" },
...
function StepContent({ index }: { index: number }) {
  switch (index) {
    ...
    case 6: return <StepCurves />;
    case 7: return <StepHydraulics />;
