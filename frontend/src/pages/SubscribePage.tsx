...
export default function SubscribePage() {
  ...
  const lapsed = new URLSearchParams(search).get("lapsed") === "true";
        ...
        <div className="w-full max-w-md">
          {lapsed && (
            <div className="mb-6 rounded-xl border border-rose-200 bg-rose-50 px-4 py-3 flex items-start gap-3">
              <svg className="h-5 w-5 text-rose-600 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" />
              </svg>
              <p className="text-sm text-rose-800">
                Your subscription has expired — please renew to continue accessing the app.
              </p>
            </div>
          )}
